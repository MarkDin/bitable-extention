...
const HelpAndFeedback: React.FC = () => {
    return (
        <div className="self-stretch h-16 relative">
            {/* 顶部分割线 */}
            <div className="w-96 h-px left-0 top-0 absolute bg-gray-100" />

            {/* 标题区域 */}
            <div className="left-4 top-[11px] absolute inline-flex justify-start items-center gap-[3px]">
                {/* 问号图标 */}
            ...
            >
                <div data-svg-wrapper className="left-0 top-[2px] absolute">
                    <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M6 3.5V10.5" stroke="#626784" strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M1.5 9C1.36739 9 1.24021 8.94732 1.14645 8.85355C1.05268 8.75979 1 8.63261 1 8.5V2C1 1.86739 1.05268 1.74021 1.14645 1.64645C1.24021 1.55268 1.36739 1.5 1.5 1.5H4C4.53043 1.5 5.03914 1.71071 5.41421 2.08579C5.78929 2.46086 6 2.96957 6 3.5C6 2.96957 6.21071 2.46086 6.58579 2.08579C6.96086 1.71071 7.46957 1.5 8 1.5H10.5C10.6326 1.5 10.7598 1.55268 10.8536 1.64645C10.9473 1.74021 11 1.86739 11 2V8.5C11 8.63261 10.9473 8.75979 10.8536 8.85355C10.7598 8.94732 10.6326 9 10.5 9H7.5C7.10218 9 6.72064 9.15804 6.43934 9.43934C6.15804 9.72064 6 10.1022 6 10.5C6 10.1022 5.84196 9.72064 5.56066 9.43934C5.27936 9.15804 4.89782 9 4.5 9H1.5Z" stroke="#626784" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                </div>
                <div className="w-20 h-4 left-[17px] top-0 absolute text-center justify-center text-gray-500 text-xs font-normal font-['PingFang_SC'] leading-none">查看使用手册</div>
            </div>
            ...
            {/* 加入群聊反馈按钮 */}
            <div
                className="w-24 h-4 left-[119px] top-[46px] absolute cursor-pointer hover:opacity-80 transition-opacity"
                onClick={() => {
                    // 这里可以添加打开群聊的逻辑
